    ...
    <BaseLayout resourceName="Reception Portal">
      <div className="w-full py-6">
        <div className="w-full max-w-6xl mx-auto px-4">
          <h1 className="text-2xl font-bold mb-4 text-center">Reception Portal</h1>
          <p className="text-sm text-gray-500 mb-4 text-center">Check-in, appointment queue and patient arrival handling.</p>
